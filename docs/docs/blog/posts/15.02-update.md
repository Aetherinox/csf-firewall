...
Pre/post script integration is now fully supported in CSF. Any existing scripts you use with CSF will continue to function without changes. This feature is now built directly into the system for seamless operation. Full documentation and usage instructions can be found here:
