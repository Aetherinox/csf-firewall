...
### Extract
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-e,  --extract` --> 
...
### Install
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-i,  --install` --> 
...
### Install Only
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-I,  --install-only` --> 
...
### Folder
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-f,  --folder` --> 
...
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-p,  --preserve-name` --> 
...
### Dryrun
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-D,  --dryrun` --> 
...
### Clean
<!-- md:version stable-15.10 --> <!-- md:fileDownload https://raw.githubusercontent.com/Aetherinox/csf-firewall/main/get.sh -->  <!-- md:source get.sh --> <!-- md:command `-c,  --clean` --> 
