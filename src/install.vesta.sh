...
run mkdir -v -m 0600 /usr/local/vesta/web/list/csf/
run cp -avf vestacp/* /usr/local/vesta/web/list/csf/
run cp -avf csf /usr/local/vesta/web/list/csf/images/
run find /usr/local/vesta/web/list/csf -type d -exec chmod -v 755 {} \;
run find /usr/local/vesta/web/list/csf -type f -exec chmod -v 644 {} \;
run mv /usr/local/vesta/web/list/csf/csf.pl /usr/local/vesta/bin/
run chmod 700 /usr/local/vesta/bin/csf.pl
