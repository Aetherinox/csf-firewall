...
CSF_WEBMIN_SHARE_HOME="/usr/share/webmin"
CSF_WEBMIN_SHARE_DEST="${CSF_WEBMIN_SHARE_HOME}/csf"
CSF_WEBMIN_LIBEXEC_HOME="/usr/libexec/webmin"
CSF_WEBMIN_LIBEXEC_DEST="${CSF_WEBMIN_LIBEXEC_HOME}/csf"
